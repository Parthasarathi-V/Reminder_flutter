                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            "Time & Date", style: TextStyle(fontSize: 18),),
                          Padding(
                            ...
                            child: TextField(
                                ...
                                /*onTap: () async {
                                  TimeOfDay? pickedTime = await showTimePicker(
                                      context: context,
                                      initialTime: selectedTime,//DateFormat('h:mm a').format(selectedTime),
                                      initialEntryMode:  TimePickerEntryMode.dial,
                                  );
                                  if (pickedTime != null) {
                                    String modifiedTime = DateFormat('h:mm a').format(pickedTime as DateTime);
                                    setState(() {
                                      _timeInput.text = modifiedTime.toString();
                                    });
                                  }
                                  else{
                                    print("not selected");
                                ...
                                decoration: InputDecoration(
                                  ...
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(10),),
                                  errorText: _validataTime
                                      ? 'time Value Can\'t Be Empty'
                                      : null,
                                ),
                            ),
                          ),
                      ...
                      children: [
                        ...
                        MaterialButton(onPressed: () async {
                          setState(() {
                            ...
                            //_timeInput.text.isEmpty ? _validataTime = true : _validataTime = false;
                          });
